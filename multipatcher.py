...
def sequential_patch_rom(rom_file, patch_directory, working_directory):
    try:
        ...
        manifest_path = os.path.join(working_directory, 'manifest.txt')
...
# Example usage
rom_file = './FF4UP-RC02.sfc'  # Replace with your ROM path (.sfc or .smc)
patch_directory = './7-Pluto'  # Directory containing .ips patches
working_directory = './patched_rom'  # Directory to store the working copy of the ROM and manifest
