...
# Define directories
style_packs_dir = Path(__file__).parent # bc current wd is /style-packs
tools_dir = style_packs_dir.parent # one dir up from this one
patchwork_dir = tools_dir.parent # two dirs up from this one
...
patch_directory = './6-Jupiter'  # Directory containing .ips patches
